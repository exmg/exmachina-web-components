  ...
  render() {
    return html`
      <div class="main">
        ...
        <div>
          <h3>Auto close with custom timing (10 sec)</h3>
          <exmg-button
            unelevated
        ...
        <div>
          <h3>Snackbar with custom offset</h3>
          <exmg-button
            unelevated
